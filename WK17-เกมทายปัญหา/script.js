...
function getCardData(){
    ...
    return cards === null ? [] : cards; //ถ้าไม่มีข้อมูลอะไรเลยก็จะส่งอาร์เรย์เปล่า ๆ ไป แต่ถ้าเป็นเท็จจะ return cards ไป
}

clearBtn.addEventListener('click',()=>{ //ลบข้อมูลใน Storage
    localStorage.clear();
